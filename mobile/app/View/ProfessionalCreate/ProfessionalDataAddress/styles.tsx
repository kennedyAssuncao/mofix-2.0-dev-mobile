...
export const ViewMask = styled.View`
    flex-direction:row;
    width:80%;
    height:7%;
    margin-top:5%;
...
export const InputDataValueNumberCompl = styled.TextInput`
    border-bottom-width:1px;
    border-color:#898989;
    background-color:#d8d8d8;
    width:50%;
...
export const InputDataValueCity = styled.TextInput`
    border-bottom-width:1px;
    border-color:#898989;
    background-color:#d8d8d8;
    width:70%;
...
export const InputDataValueState = styled.TextInput`
    border-bottom-width:1px;
    border-color:#898989;
    background-color:#d8d8d8;
    width:30%;
